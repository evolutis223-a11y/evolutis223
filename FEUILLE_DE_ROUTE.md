...
| 2 — Workflows spécifiques | **~40%** | 2.1 (réserve détail, `/validations`) et 2.2 (Kits) faits et vérifiés en base réelle. Reste : 2.3→2.5 (OF, Fonds en circulation, Proformas). |
