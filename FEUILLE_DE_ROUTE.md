...
| 2 — Workflows spécifiques | **~20%** | 2.1 (réserve détail : blocage + écran de décision `/validations`) fait et vérifié en base réelle (Autoriser + Recharger testés, FIFO par lot, audit tracé). Reste : 2.2→2.5 (Kits, OF, Fonds en circulation, Proformas). |
