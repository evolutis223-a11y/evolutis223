...
| 4 — Modules périphériques | **~70%** | Fournisseurs (2026-07-29), RH (2026-08-01, personnel + bulletins de paie + incidents + besoins saisonniers), Achats et Dépenses/Charges (2026-08-02, écrans dédiés sur Fournisseurs/Stock/Trésorerie existants) faits et vérifiés en base réelle. Rapports — 4 dimensions faites et vérifiées (Finance, RH, Incidents, Prévisions, 2026-08-02). Reste : Marketing (délégué à Claude par l'utilisateur, pas encore attaqué). |
...
- **Marketing** : scope délégué entièrement à Claude par l'utilisateur (2026-08-02, "tu gères") — pas encore construit, prochain sur la liste.
