...
| 4 — Modules périphériques | **~30%** | Fournisseurs fait et vérifié en base réelle 2026-07-29 (`/fournisseurs`, `lots.fournisseur_id` câblé dans les 2 formulaires d'approvisionnement de Stocks). RH fait et vérifié en base réelle 2026-08-01 (`/rh`, registre personnel + bulletins de paie + décaissement RH_SALAIRE, voir détail §7). Achats, Dépenses, Charges, Rapports, Marketing pas commencés (n'est pas bloquant, peut suivre le lancement). |
